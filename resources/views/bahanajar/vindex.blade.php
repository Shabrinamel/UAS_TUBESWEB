...
<body>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mt-4 mb-4">Pengembangan Bahan Ajar</h2>
            <div>
                <a class="btn btn-primary mr-2" href="{{ url('bahanajar/create') }}">
                    Tambah
                </a>
        ...
        <table id="JabatanTable" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>                    
                        <a class="btn btn-primary mr-2" href="{{ url('berkas_bahanajar/'.$item->filename) }}">
                        {{$item->filename}}
                        </a>
                    </td>
                    <td>
                    <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('bahanajar/'.$item->id) }}" method="post">
                        @csrf 
                        @method('DELETE')
                        <div class="col-sm-10">
