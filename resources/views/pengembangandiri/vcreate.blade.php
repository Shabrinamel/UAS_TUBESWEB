...
<form action="{{ url('pengembangandiri') }}" method='post' enctype="multipart/form-data">
@csrf
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="mb-3 row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="durasi" name="durasi" placeholder="durasi" value="">
      </div>
    </div>
    <div class="mb-3 row">
